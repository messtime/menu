...
export default {
  ...
  methods: {
    generateMenu() {
      ...
      var select = this.allArr[Math.floor(Math.random() * this.allArr.length)];
      var list = select.list;
      this.type = this.typeMap[select.name] + ":  ";
      this.result = list[Math.floor(Math.random() * list.length)].name;
    ...
    generate() {
      ...
      var result = list[Math.floor(Math.random() * list.length)].name;
      var flag = false;
